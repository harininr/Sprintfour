  ...
  return (
    <div className="min-h-screen flex bg-white font-sans selection:bg-[#6B1E2B]/20">
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center px-8 sm:px-16 lg:px-24 xl:px-32 relative z-10">
        ...
        >
          <h1 className="text-3xl font-serif font-bold text-[#1F1F1F] mb-3">Create an account</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-[52px] bg-[#1F1F1F] text-white hover:bg-black rounded-xl shadow-lg shadow-black/5 font-semibold text-[15px] transition-all hover:scale-[1.02] mt-4"
            >
          ...
          <div className="mt-10 text-center">
            <p className="text-[14px] text-gray-500">
              ...
              <Link href="/login" className="text-[#1F1F1F] font-semibold hover:text-[#6B1E2B] transition-colors cursor-pointer">
                Sign in
              </Link>
            </p>
          </div>
      ...
      <div className="hidden lg:flex flex-1 relative bg-[#FDFBF7] overflow-hidden items-center justify-center border-l border-[#E8DED1]">
        ...
        >
          ...
          <h2 className="text-3xl font-serif font-bold text-[#1F1F1F] mb-4">Privacy meets intelligence.</h2>
